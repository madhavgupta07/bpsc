...
export const NOTES = [ch01, ch02, ch03, ch04, ch05, ch06, ch07, ch08, ch09, ch10, ch11, ch12, ch13, ch14, ch15, ch16, ch17];

/** Get a chapter's notes by its 1-based number. */
export function getNote(num) {
  const n = Number(num);
  return NOTES.find((c) => c.num === n) || null;
}
